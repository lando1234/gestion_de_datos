   ...
   public class Credito : Rol
    {
        ...
        public Credito(Nullable<int> id, DateTime fecha, int tipo_pago_id, Double monto, int usuario_id, string tarjeta_nombre, Nullable<DateTime> fecha_vencimiento, Nullable<int> numero_tarjeta)
        {
            this.id = id;
            this.fecha = fecha;
